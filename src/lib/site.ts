export const site = {
  ...
  // If/when you want WhatsApp reservations, set this to an E.164 number WITHOUT + (example: 381611435845)
  ...
  mapsUrl: "https://www.google.com/maps/place/LAT%C4%B0FE+BELGRAD/data=!4m2!3m1!1s0x475a7b49b62bfc4f:0x8cc2c0ae0f219cea?sa=X&ved=1t:242&ictx=111",
  // Embed uses address query to avoid needing a special pb code
  mapsEmbedUrl: "https://www.google.com/maps?q=LATIFE%20BELGRAD%20Zmaj%20Jovina%207%20Beograd&output=embed",
  hours: {
    mon: "08:30–22:30",
    tue: "08:30–22:30",
    wed: "08:30–22:30",
...
export function whatsappHref(e164: string, text?: string){
  ...
  return `https://wa.me/${e164}${encoded}`;
}
